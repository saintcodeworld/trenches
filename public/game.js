...
(function () {
  ...
  function generateRandomName() {
    const adjectives = ['Swift', 'Brave', 'Silent', 'Quick', 'Sharp', 'Bold', 'Cool', 'Fast', 'Smart', 'Wild'];
    const nouns = ['Eagle', 'Tiger', 'Wolf', 'Fox', 'Hawk', 'Lion', 'Bear', 'Shark', 'Storm', 'Shadow'];
  ...
  // Send random name to server
  socket.emit('set_player_name', myRandomName);
